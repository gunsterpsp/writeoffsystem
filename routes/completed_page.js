...
completedRouter.get("/completed", (req, res) => {
    res.render("completed")
})


// FETCH API USERS
completedRouter.get('/api/completed/read', (req, res, next) => {
        ...
        ) as 'final_percentage' FROM tbl_request_folder t1 WHERE branch_requested = '${req.session.branch_code}' AND request_status = 'Completed' GROUP BY request_id`
